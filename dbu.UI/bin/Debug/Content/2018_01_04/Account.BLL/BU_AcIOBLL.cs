...
{
	public class BU_AcIOBLL
	{
		
		BU_AcIODAL _dal = new BU_AcIODAL();
		...
		{
			return _dal.ListToDataTable(bu_acios,IsIdentity,IsComputed);
		}
		#endregion
