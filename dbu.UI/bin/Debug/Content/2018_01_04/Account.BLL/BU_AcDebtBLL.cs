...
{
	public class BU_AcDebtBLL
	{
		
		BU_AcDebtDAL _dal = new BU_AcDebtDAL();
		...
		{
			return _dal.ListToDataTable(bu_acdebts,IsIdentity,IsComputed);
		}
		#endregion
