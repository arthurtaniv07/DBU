...
{
	public class BU_AcBookBLL
	{
		
		BU_AcBookDAL _dal = new BU_AcBookDAL();
		...
		{
			return _dal.ListToDataTable(bu_acbooks,IsIdentity,IsComputed);
		}
		#endregion
