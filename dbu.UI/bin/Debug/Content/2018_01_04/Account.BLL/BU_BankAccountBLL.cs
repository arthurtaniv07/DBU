...
{
	public class BU_BankAccountBLL
	{
		
		BU_BankAccountDAL _dal = new BU_BankAccountDAL();
		...
		{
			return _dal.Add(_bU_BankAccount);
		}
		#endregion
		...
		{
			return _dal.Update(_bU_BankAccount);
		}
		#endregion
		...
		{
			return _dal.Delete(_bU_BankAccount);
		}
		#endregion
		...
		{
			return _dal.ListToDataTable(bu_bankaccounts,IsIdentity,IsComputed);
		}
		#endregion
